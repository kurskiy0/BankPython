...
#def test_filter_by_currency(filter_correct):
 #   assert filter_by_currency(transactions) == filter_correct
  #  assert filter_by_currency([]) == 'Отсутствует значение'


def test_transaction_descriptions(filter_correct):
    assert list(transaction_descriptions(filter_correct)) == ["Перевод организации",
...
def test_card_number_generator():
    assert list(card_number_generator(1234, 1236)) == ['0000 0000 0000 1234',
                                                                 '0000 0000 0000 1235',
                                                                 '0000 0000 0000 1236']
